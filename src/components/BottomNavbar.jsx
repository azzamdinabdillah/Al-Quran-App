...
const BottomNavbar = () => {
  ...
  return (
    <section
      ...
      // }}
      className="w-full fixed bottom-0 md:w-[15%] lg:w-[10%] md:top-0 md:left-0 bg-white dark:bg-[#2B303B] z-40 shadow-2xl shadow-black dark:shadow-white md:shadow-none"
    >
